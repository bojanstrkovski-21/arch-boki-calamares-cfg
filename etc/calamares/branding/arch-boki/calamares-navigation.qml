...
Rectangle {
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            color: mouseBack.containsMouse ? "#d3c6aa" : "#d3c6aa";
        ...
        Rectangle {
            ...
            Layout.preferredHeight: parent.height / 7;
            Layout.fillWidth: true
            color: mouseNext.containsMouse ? "#d36aa" : "#d3c6aa";
        ...
        Rectangle {
            ...
            Layout.fillWidth: true
            color: mouseCancel.containsMouse ? "#d3c6aa" : "#d3c6aa";
 ...
 72
branding/arch-boki/calamares-sidebar.qml
@@ -0,0 +1,72 @@
