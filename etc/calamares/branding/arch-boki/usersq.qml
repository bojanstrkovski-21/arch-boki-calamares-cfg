...
Kirigami.ScrollablePage {
    ...
    readonly property color unfilledFieldColor: "#d3c6aa" //Kirigami.Theme.backgroundColor
    readonly property color positiveFieldColor: "#d3c6aa" //Kirigami.Theme.positiveBackgroundColor
    readonly property color negativeFieldColor: "#d699b6" //Kirigami.Theme.negativeBackgroundColor
    readonly property color unfilledFieldOutlineColor: "#d3c6aa"
    readonly property color positiveFieldOutlineColor: "#83c092"
    readonly property color negativeFieldOutlineColor: "#e67e80"
    readonly property color headerTextColor: "#d3c6aa"
    readonly property color commentsColor: "#d3c6aa"
